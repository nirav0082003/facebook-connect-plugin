...
public class ConnectPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("login")) {
            ...
            callbackContext.success();
            return true;
        } else if (action.equals("trackCreateAccountEvent")) {
            /*
             * While calls to logEvent can be made to register purchase events,
             * there is a helper method that explicitly takes a currency indicator.
             */
            ...
            String installGUID = args.getString(0);

            Bundle parameters = new Bundle();

            // Try get a String
            parameters.putString(AppEventsConstants.EVENT_PARAM_REGISTRATION_METHOD, "Email");
            parameters.putString("installationGUID", installGUID);

            logger.logEvent(AppEventsConstants.EVENT_NAME_COMPLETED_REGISTRATION, parameters);

            callbackContext.success();
            return true;
        }else if (action.equals("trackGradePickEvent")) {
            /*
             * While calls to logEvent can be made to register purchase events,
             * there is a helper method that explicitly takes a currency indicator.
             */
            ...
            String grade = args.getString(1);

            Bundle parameters = new Bundle();

            // Try get a String
            parameters.putString("grade", grade);
        ...
        else if (action.equals("trackSubjectPickEvent")) {
            /*
             * While calls to logEvent can be made to register purchase events,
             * there is a helper method that explicitly takes a currency indicator.
             */
            ...
            callbackContext.success();
            return true;
        }else if (action.equals("trackTopicPickEvent")) {
            /*
             * While calls to logEvent can be made to register purchase events,
             * there is a helper method that explicitly takes a currency indicator.
             */
            ...
            // Try get a String
            parameters.putString("username", username);
            parameters.putString("topic", topic);

            logger.logEvent(AppEventsConstants.EVENT_NAME_ADDED_TO_CART, parameters);

            callbackContext.success();
            return true;
        }else if (action.equals("trackQuestionTypePickEvent")) {
            /*
             * While calls to logEvent can be made to register purchase events,
             * there is a helper method that explicitly takes a currency indicator.
             */
            ...
            String username = args.getString(0);
            String questionType = args.getString(1);

            Bundle parameters = new Bundle();

            // Try get a String
            parameters.putString("username", username);
            parameters.putString("questionType", questionType);

            logger.logEvent(AppEventsConstants.EVENT_NAME_ADDED_TO_WISHLIST, parameters);

            callbackContext.success();
            return true;
        }else if (action.equals("trackSessionEvent")) {
            /*
             * While calls to logEvent can be made to register purchase events,
             * there is a helper method that explicitly takes a currency indicator.
             */
            ...
            logger.logEvent(AppEventsConstants.EVENT_NAME_SPENT_CREDITS, parameters);

            callbackContext.success();
            return true;
        }
        else if (action.equals("trackMentorRatedEvent")) {
            /*
             * While calls to logEvent can be made to register purchase events,
             * there is a helper method that explicitly takes a currency indicator.
             */
            ...
            String username = args.getString(0);
            String rating = args.getString(1);

            Bundle parameters = new Bundle();

            // Try get a String
            parameters.putString("username", username);
            parameters.putString("rating", rating);

            logger.logEvent(AppEventsConstants.EVENT_NAME_RATED, parameters);

            callbackContext.success();
            return true;
        }else if (action.equals("trackMeetAgainEvent")) {
            /*
             * While calls to logEvent can be made to register purchase events,
             * there is a helper method that explicitly takes a currency indicator.
             */
        ...
        else if (action.equals("registerFacebookAds")) {
            /*
             * While calls to logEvent can be made to register purchase events,
             * there is a helper method that explicitly takes a currency indicator.
             */
